  ...
  return (
    <div className="bg-white px-[3rem] md:px-[8rem] py-[5rem]  flex flex-col items-center  gap-[2rem] lg:gap-[5rem]">
      <div className="text-white flex flex-col gap-[1rem]">
        <h1 className="text-[2rem] text-black ">Email Us</h1>
      </div>
      <form className="flex flex-col gap-[1rem] items-center lg:w-[100%] grow" ref={form}>
        ...
        <Input
          ...
          radius="none"
        />
        <Textarea label="Message" name="message" variant="bordered" classNames={{ input: "text-black" }} radius="none" />
        <Button
          
          variant="shadow"
          radius="none"
          className="w-[12rem] h-[3rem]  text-white bg-blue-500"
