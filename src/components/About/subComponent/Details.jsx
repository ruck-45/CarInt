    ...
    <div className="flex lg:flex-row flex-col items-center justify-evenly md:p-[5rem] p-[2rem] gap-10">
      ...
      <div className="flex flex-col justify-center items-start">
        <div className="py-[2rem]">
          <h1 className="text-serif font-bold text-4xl text-blue-600">About <span className="text-gray-700">Us</span></h1>
        </div>
        ...
        <div className="py-[1rem] ">
          <button className="py-[1rem] px-[2rem] bg-blue-600 text-white">Read More</button>
        </div>
      </div>
      ...
      <div className="">
        <div >
          <img className="w-[100rem] h-[20rem]"
